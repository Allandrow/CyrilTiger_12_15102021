...
const UserBarChart = ({ activity }) => {
  if (!activity) console.log('wtf')
  return (
    <ResponsiveContainer height="100%" width="100%">
      <BarChart height="250" width="100%" data={activity}>
        <XAxis dataKey="day" />
        <YAxis dataKey="kilogram" />
        <Bar dataKey="kilogram" fill="#282D30" isAnimationActive={false} />
        <Bar dataKey="calories" fill="#FF0101" isAnimationActive={false} />
      </BarChart>
    </ResponsiveContainer>
  )
}
